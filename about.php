            ...
            <section class="gallery">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-4 ps-0">
                            <img src="images/gallery/gallery2.png" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>
                        
                        <div class="col-lg-4 col-4 ps-0">
                            <img src="images/gallery/contact_form.png" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-4 col-4 pe-0">
                            <img src="images/gallery/blog1.png" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
